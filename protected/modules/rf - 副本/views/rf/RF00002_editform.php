...
<div class="container" style="padding-top: 8px;">
    <div class="row">
        ...
        <div class="col-8" style="background-color: #F2F9FA;text-align: center">
            ...
            <div class="row" style="margin-top: 8px;">
                <label for="program_name" class="col-sm-5 offset-md-1 control-label padding-lr5" style="text-align: left">Type of service</label>
            ...
            <div class="row" style="margin-top: 8px;">
                <label for="program_name" class="col-sm-5 offset-md-1 control-label padding-lr5" style="text-align: left">Latest Date to Reply</label>
            ...
            <div class="row" style="margin-top: 8px;">
                <label for="program_name" class="col-sm-5 offset-md-1 control-label padding-lr5" style="text-align: left">HDB List of Approved Materials</label>
                <div class="col-sm-5 padding-lr5" style="text-align: left;">
                ...
                <div class="col-sm-8 offset-md-1 padding-lr5">
                    <table id="attach"  style="width: 70%">
                        ...
                        foreach($attach_list as $i => $j){
                            ...
                            echo "<tr> <td align='left'><img src='img/attach.png'></td><td align='left'>".$j['doc_name']."</td> <td align='right' width='25%'><a onclick='previewdoc(\"$file_path\")'>Preview</a></td><td align='center' width='25%'><a onclick='del_attachment(this)'>Delete</a><input type='hidden' name='rf[attachment][]' value=\"$file_path\"></td></tr>";
                        }
                        ?>
                    </table>
                </div>
