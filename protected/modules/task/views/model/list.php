        ...
        <div class="card card-info card-outline">
                ...
                <div class="row" style="margin-bottom: 8px;">
                    <div class="col-9" style="text-align: right;margin-bottom: 0px;">
                        <ul class="nav nav-pills" role="tablist" id="myTab">
                            ...
                            if($pbu_tag == '1'){
                                ?>
                                <li role="presentation" class="nav-item"><a class="nav-link" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=2">PPVC</a></li>
                                <li role="presentation" class="nav-item"><a class="nav-link active" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=1" >PBU</a></li>
                                <li role="presentation" class="nav-item"><a class="nav-link" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=3">Precast</a></li>
                                <?php
                            }else if($pbu_tag == '2'){
                                ?>
                                <li role="presentation" class="nav-item"><a class="nav-link active" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=2">PPVC</a></li>
                                <li role="presentation" class="nav-item"><a class="nav-link" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=1">PBU</a></li>
                                <li role="presentation" class="nav-item"><a class="nav-link" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=3">Precast</a></li>
                                <?php
                            }else if($pbu_tag == '3'){
                                ?>
                                <li role="presentation" class="nav-item"><a class="nav-link" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=2">PPVC</a></li>
                                <li role="presentation" class="nav-item"><a class="nav-link" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=1">PBU</a></li>
                                <li role="presentation" class="nav-item"><a class="nav-link active" href="index.php?r=task/model/list&program_id=<?php echo $program_id ?>&pbu_tag=3">Precast</a></li>
                                <?php
                            }
                            ?>
                        </ul>
            ...
            <div class="card-body" style="overflow-x: auto">
                <div role="grid" class="dataTables_wrapper" id="<?php echo $this->gridId; ?>_wrapper">
                    <?php $this->renderPartial('_toolBox',array('program_id'=>$program_id,'args'=>$args,'pbu_tag'=>$pbu_tag)); ?>
