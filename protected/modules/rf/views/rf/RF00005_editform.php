    ...
    <div class="col-12">
        <div class="card card-info card-outline">
            <div class="card-body" style="background-color: #F2F9FA;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-1 offset-md-2 control-label padding-lr5" style="text-align: left">Subject<span style="color: #c12e2a">*</span></label>
                    <div class="col-sm-7 padding-lr5" style="margin-left: 15px;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-4 offset-md-2 control-label padding-lr5" style="text-align: left">Discipline</label>
                    <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                        <input id="related" class="form-control" name="rf[related]" check-type="required" required-message="Project Name can not be empty"  type="text" value="<?php echo $item_list[0]['discipline'] ?>" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                        <input id="location" class="form-control" name="rf[location]" check-type="required" required-message="Project Name can not be empty"  type="text" value="<?php echo $item_list[0]['location_ref'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-4 offset-md-2 control-label padding-lr5" style="text-align: left">Attachment</label>
