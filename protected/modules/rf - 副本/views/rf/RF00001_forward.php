...
<div class="container" style="padding-top: 8px;">
    <div class="row">
        ...
        <div class="col-10" style="background-color: #F2F9FA;text-align: center">
            ...
            <!--                <div class="col-sm-3 padding-lr5">-->
            <!--                    <input id="check_no" name="rf[check_no]" class="form-control" style="background: #F2F2F2" type="text"  value="--><?php //echo $check_no; ?><!--">-->
            <!--                </div>-->
            <!--            </div>-->
            <!--        </div>-->
            ...
            <div class="row" style="margin-top: 8px;border-bottom:4px solid #F2F2F2;padding-bottom:8px;">
                ...
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                    <input id="subject" class="form-control" name="rf[subject]" check-type="required" required-message="Project Name can not be empty"  type="text" value="<?php echo $subject; ?>" >
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 8px;border-bottom:4px solid #F2F2F2;padding-bottom:8px;">
                ...
                <div class="col-sm-5 padding-lr5" style="margin-left: 15px;text-align: left">
                    <?php
                    if($item_list[0]['spec_ref'] =='Complied'){
                        echo "<input type='radio' id='complied' name='item[spec_ref]'  value='Complied' checked='checked'  /> Complied
                    ...
                    }else if($item_list[0]['spec_ref'] =='Partially Complied'){
                        echo "<input type='radio' id='complied' name='item[spec_ref]'  value='Complied'   /> Complied
                                  <input type='radio' id='partially_complied' name='item[spec_ref]'  value='Partially Complied' style='padding-left: 4px;'  checked='checked'/> Partially Complied
                                  <input type='radio' id='not_complied' name='item[spec_ref]'  value='Not Complied' style='padding-left: 4px;'  /> Not Complied";
                    }else{
                        echo "<input type='radio' id='complied' name='item[spec_ref]'  value='Complied'   /> Complied
                                  <input type='radio' id='partially_complied' name='item[spec_ref]'  value='Partially Complied' style='padding-left: 4px;'  /> Partially Complied
                                  <input type='radio' id='not_complied' name='item[spec_ref]'  value='Not Complied' style='padding-left: 4px;' checked='checked' /> Not Complied";
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="row" >
                <table id="attach" class="offset-md-2" style="width: 60%">
                    <?php
                    foreach($attach_list as $i => $j){
                        $file_path = 'opt/www-nginx/web'.$j['doc_path'];
                        echo "<tr> <td align='right'><img src='img/attach.png'></td><td align='center'>".$j['doc_name']."</td> <td align='right' width='25%'><a onclick='previewdoc(\"$file_path\")'>Preview</a></td><td align='right' width='25%'><a onclick='del_attachment(this)'>Delete</a><input type='hidden' name='rf[attachment][]' value=\"$file_path\"></td></tr>";
                    }
                    ?>
                </table>
            </div>
