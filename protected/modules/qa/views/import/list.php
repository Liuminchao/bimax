...
<?php echo $this->gridId; ?>.refresh();
    ...
    //详情
    var itemDetail = function (form_id,program_id,checklist_name) {
        window.location = "index.php?r=qa/import/detaillist&form_id="+form_id+"&program_id="+program_id+"&checklist_name="+checklist_name;
    }
    //修改
        ...
        <div class="card card-info card-outline">
            <div class="card-body" style="overflow-x: auto">
                <div role="grid" class="dataTables_wrapper " id="<?php echo $this->gridId; ?>_wrapper">
                    <?php $this->renderPartial('_toolBox',array('args'=>$args,'program_id'=>$program_id)); ?>
