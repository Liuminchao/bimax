        ...
        <div class="card card-info card-outline">
            <div class="card-body" style="background-color: #F2F9FA;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-5 padding-lr5" style="padding-left: 15px;">
                ...
                <div class="form-group " style="height:200px;margin-top: 10px;">
                    <div class="col-sm-3 padding-lr5"></div>
                    <div class="col-sm-8 padding-lr5">
                        <textarea  id="a_item" name = "item[a_item]" style="height:200px;width:100%"></textarea>
                    </div>
                    <div class="col-sm-1 padding-lr5"></div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_spec_clause" name="item[check_spec_clause]" type="checkbox" value="0" />Specification Clause(e)</div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-1 padding-lr5"></div>
                    <div for="program_name" class="col-sm-2 control-label padding-lr5" ></div>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_contract_draw" name="item[check_contract_draw]" type="checkbox" value="0" />Contract Drawing No.</div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-1 padding-lr5"></div>
                    <div for="program_name" class="col-sm-2 control-label padding-lr5" ></div>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_product_spec" name="item[check_product_spec]" type="checkbox" value="0" />Product Specifications</div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-1 padding-lr5"></div>
                    <div for="program_name" class="col-sm-2 control-label padding-lr5" ></div>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_meth_state" name="item[check_meth_state]" type="checkbox" value="0" />Method Statement</div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-1 padding-lr5"></div>
                    <div for="program_name" class="col-sm-2 control-label padding-lr5" ></div>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_pe" type="checkbox" name="item[check_pe]" value="0" />PE calculations (endsorsed)</div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-1 padding-lr5"></div>
                    <div for="program_name" class="col-sm-2 control-label padding-lr5" ></div>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_color_chart" type="checkbox" name="item[check_color_chart]" value="0" />Color chart</div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-1 padding-lr5"></div>
                    <div for="program_name" class="col-sm-2 control-label padding-lr5" ></div>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_hdb_letter" name="item[check_hdb_letter]" type="checkbox" value="0" />HDB Approved Letter</div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-1 padding-lr5"></div>
                    <div for="program_name" class="col-sm-2 control-label padding-lr5" ></div>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_test_report" name="item[check_test_report]" type="checkbox" value="0" />Document</div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-1 padding-lr5"></div>
                    <div for="program_name" class="col-sm-2 control-label padding-lr5" ></div>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;padding-top: 7px;"><input id="check_others" name="item[check_others]"  type="checkbox" value="0" />Others</div>
