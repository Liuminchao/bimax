            ...
            <div class="card-body" style="background-color: #F2F9FA;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <?php }else if($item_data['rvo'] == '2'){ ?>
                        ...
                        <div class="col-sm-3 padding-lr5" style="text-align: left;">
                            <input type='radio' id='no_rvo' name='item[rvo]'  value='2' checked style='padding-left: 4px;'  /> No
                        </div>
                        <div class="col-sm-2 padding-lr5" style="text-align: left;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Type of service</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="service" class="form-control" name="item[service]" check-type="required" required-message="Content can not be empty"  type="text" value="<?php echo $item_data['service'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Latest Date to Reply</label>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Trade</label>
                    <div class="col-sm-3 padding-lr5" style="text-align: left;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Masterial/Equipment Specified</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="mas_spc" class="form-control" name="item[mas_spc]"   type="text" value="<?php echo $item_data['mas_spc'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Location To Be Installed</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="loc_ins" class="form-control" name="item[loc_ins]" check-type="required" required-message="Project Name can not be empty"  type="text" value="<?php echo $item_data['loc_ins'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Masterial/Equipment Submitted</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="mas_sub" class="form-control" name="item[mas_sub]"   type="text" value="<?php echo $item_data['mas_sub'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Supplier</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="supplier" class="form-control" name="item[supplier]"   type="text" value="<?php echo $item_data['supplier'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">HDB List of Approved Supplier</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="hdb_sup" class="form-control" name="item[hdb_sup]"   type="text" value="<?php echo $item_data['hdb_sup'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Manufacturer/Brand</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="brand" class="form-control" name="item[brand]"   type="text" value="<?php echo $item_data['brand'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">HDB List of Approved Materials</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="hdb_mat" class="form-control" name="item[hdb_mat]"   type="text" value="<?php echo $item_data['hdb_mat'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Model / Type</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="model" class="form-control" name="item[model]"   type="text" value="<?php echo $item_data['model'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Country of Origin</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="origin" class="form-control" name="item[origin]"   type="text" value="<?php echo $item_data['origin'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Complaince With Specifications/standard</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="comp_spec" class="form-control" name="item[comp_spec]"  type="text" value="<?php echo $item_data['comp_spec'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Technical Brochures Submitted</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="tech_sub" class="form-control" name="item[tech_sub]"   type="text" value="<?php echo $item_data['tech_sub'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-3 offset-md-1 control-label padding-lr5" style="text-align: left">Test Certificate Submitted</label>
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="cert_sub" class="form-control" name="item[cert_sub]"   type="text" value="<?php echo $item_data['cert_sub'] ?>" >
                    </div>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <label for="program_name" class="col-sm-2 offset-md-1 control-label padding-lr5" style="text-align: left">Message</label>
                </div>

                <div class="form-group" style="margin-top: 10px;">
                    <div class="col-sm-10 offset-md-1 padding-lr5">
                        <textarea rows="10" id="message" name = "rf[message]" style="width:100%"><?php echo $detail_list[0]['remark'] ?></textarea>
                    </div>
                </div>
