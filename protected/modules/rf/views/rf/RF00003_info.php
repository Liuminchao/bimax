...
<!--                    </div>-->
                    <div class="col-12" style="text-align: center">
                        ...
                        <div class="row" style="margin-top: 8px;">
                            <div class="col-sm-1 control-label padding-lr5" style="">
                                <button type="button" class="btn btn-primary" style="background-color: #FF9966;" onclick="back()">Back</button>
                            </div>
                            <div class="col-sm-11 control-label padding-lr5" style="text-align: right;">
                                <?php
                                $apply_user_id = $rf_model->apply_user_id;
                    ...
                    ";
                        ...
                        <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='text-align: left'>Submission for</label>";
                            ...
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='text-align: left'>Trade</label>
                                ...
                                echo $trade_name;
                                echo "</div>";
                                echo "<label for='program_name' class='col-sm-3 control-label padding-lr5' style='text-align: left'>Latest Date to Reply</label>
                            <div class=' col-sm-3 padding-lr5' style='text-align: left;'>";
                                $rf_model = RfList::model()->findByPk($check_id);
                          ...
                          <div class='row' style='margin-top: 8px;'>
                            ...
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left'>Attachment(".$count.")</label>
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-3 offset-md-1 control-label padding-lr5' style='text-align: left'>b.Item Submitted</label>
                          </div>";
                            ...
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> Specification Clause(e)</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>      
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <div for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' ></div>
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> Contract Drawing No.</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>      
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <div for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' ></div>
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> Product Specifications</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>      
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <div for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' ></div>
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> Method Statement</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>      
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <div for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' ></div>
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> PE calculations (endsorsed)</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <div for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' ></div>
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> Color chart</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <div for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' ></div>
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> HDB Approved Letter</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>  
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <div for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' ></div>
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> Document</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <div for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' ></div>
                            <div class='col-sm-3 padding-lr5' style='text-align: left;padding-top:7px;'><input id='check_spec_clause' name='item[check_spec_clause]' type='checkbox' disabled  $check/> Others</div>
                            <div class='col-sm-5 padding-lr5'><input id='spec_clause' class='form-control' name='item[spec_clause]'   type='text' value='$value' readonly></div>
                          </div>";
                                echo "</div>";
                            ...
                            <div class='row' style='margin-top: 8px;'>
                                ...
                                echo $to_user;
                                echo "</div>
                            <div class='col-sm-4 padding-lr5' style=''><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span></div>
                        </div>";
                          ...
                          <input type='radio'  style='padding-left: 4px;' checked disabled > NA";
                            ...
                            <label for='program_name' class='col-sm-2 offset-md-3 control-label padding-lr5' style='text-align: left'>Attachment(".$count.")</label>";
                                ...
                                foreach($attach_list as $i => $j){
                                    ...
                                    $doc_arr = explode('.',$j['doc_name']);
                                    if($doc_arr[1] == 'dwg' || $doc_arr[1] == 'zip' || $doc_arr[1] == 'rar'){
                                        echo "<div class='row col-12 offset-md-1' style='margin-top: 8px;'><div class='col-sm-1 offset-md-1 padding-lr5'></div><div class='col-sm-6 padding-lr5' style='text-align: left;padding-left: 0px;'><img src='img/attach.png'>$doc_name</div><div class='col-sm-2 padding-lr5' style='text-align: left'><a  class='a_logo'  style='cursor:pointer;'  onclick='download_one(\"$doc_path\",\"$doc_name\")' title='Download'><i class='fa fa-fw fa-download'></i></a><a  class='a_logo'  style='cursor:pointer;margin-left: 5px;'  onclick='save_one(\"$check_id\",\"$doc_path\")'><i class='fa fa-fw fa-save' title='Save as'></i></a></div></div>";
                                    }else{
                                        echo "<div class='row col-12 offset-md-1' style='margin-top: 8px;'><div class='col-sm-1 offset-md-1 padding-lr5'></div><div class='col-sm-6 padding-lr5' style='text-align: left;padding-left: 0px;'><img src='img/attach.png'>$doc_name</div><div class='col-sm-2 padding-lr5' style='text-align: left'><a  class='a_logo' onclick='previewdoc(\"$file_path\")' style='cursor:pointer' title='Preview'><i class='fa fa-fw fa-eye'></i></a><a  class='a_logo' onclick='download_one(\"$doc_path\",\"$doc_name\")' style='cursor:pointer;margin-left: 5px;' title='Download'><i class='fa fa-fw fa-download'></i></a><a class='a_logo' onclick='save_one(\"$check_id\",\"$doc_path\")' style='cursor:pointer;margin-left: 5px;' title='Save as'><i class='fa fa-fw fa-save'></i></a></div></div>";
                                    }
                                }
                        ...
                        <div class='row' style='margin-top: 8px;'>
                          ...
                          <label for='program_name' class='col-sm-2 control-label padding-lr5' style='text-align: left'>Attachment(".$count.")</label>";
                                ...
                                echo "
                            <div class='col-sm-3 padding-lr5' style=''><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span></div>
                        </div>";
