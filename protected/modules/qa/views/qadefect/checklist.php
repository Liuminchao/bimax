...
//        modal.title = "["+app_id+"] <?php //echo Yii::t('sys_workflow', 'Approval Process'); ?>//";
    ...
    function itemBack (source) {
        if(source == 'inspection'){
            window.location = "./?<?php echo Yii::app()->session['list_url']['qainspection/list']; ?>";
        }
        if(source == 'dfma'){
        ...
        <div class="card card-info card-outline">
            ...
            <div class="card-body" style="overflow-x: auto">
                <div role="grid" class="dataTables_wrapper " id="<?php echo $this->gridId; ?>_wrapper">
                    <?php $this->renderPartial('check_toolBox',array('program_id'=>$program_id,'source'=>$source,'args'=>$args)); ?>
                    <div id="datagrid"><?php $this->actionCheckGrid($check_id,$source); ?></div>
                </div>
            </div>
            <!-- /.card -->
        </div>
