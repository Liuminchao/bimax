<div class="row" >
    <div class="col-9">
        <div class="dataTables_length">
            <form class="form-inline" name="_query_form" id="_query_form" role="form">
                ...
                <div class="form-group  padding-lr5" style="width: 120px;">
                    <input type="text" class="form-control input-sm" name="q[role_name]" placeholder="<?php echo Yii::t('sys_role', 'role_name'); ?>" style="width: 100%;">
                </div>
    ...
    <div class="col-3">
        <div class="dataTables_filter" >
            <div>
                <button class="btn btn-primary btn-sm" onclick="itemBack('<?php echo $project_id ?>')">Back</button>
