<form name="query_form" id="_query_form_6" role="form">
    <div class="row" style="display:none;">
        ...
        <div class="form-group padding-lr5" style="width:200px">
            <select class="form-control input-sm" name="q[template_id]"  id="template_id_4" style="width: 100%;">
                <?php
        ...
        <a class="tool-a-search" href="javascript:itemQuery_6();"><i class="fa fa-fw fa-search"></i> Search</a>
    </div>
</form>