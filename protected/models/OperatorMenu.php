...
//            self::TYPE_FACEFORM => Yii::t('sys_operator','TYPE_FACEFORM'),
    ...
    public static  function updateMenu($args){
        ...
        $status = '00';
        $sql = "delete from bac_operator_menu_q where operator_id = '".$args['operator_id']."'";
    ...
    public static function appMenuList($operator_id){
        ...
        $sql = "SELECT a.menu_id,b.menu_name,b.menu_name_en FROM bac_operator_menu_q a,sys_menu b WHERE a.status ='00' and a.operator_id = '".$operator_id."' and a.menu_id = b.menu_id and b.menu_status='00' and b.app_type like '%2%' ";
        $command = Yii::app()->db->createCommand($sql);
