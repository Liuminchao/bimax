 ...
 * @author LiuMinchao
 */
class TransmittalUser extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'transmittal_record_user';
    }
    ...
    public static function insertList($args,$to_user){
        ...
        foreach($to_user as $i => $to_user_id){
            if($to_user_id){
                ...
                $type = '1';
                $sql = "insert into transmittal_record_user (check_id,step,contractor_id,contractor_name,user_id,user_name,type) values (:check_id,:step,:contractor_id,:contractor_name,:user_id,:user_name,:type)";
...
//                $trans->rollBack();
    ...
    public static function userListByStep($check_id,$step) {
        $sql = "select * from transmittal_record_user
