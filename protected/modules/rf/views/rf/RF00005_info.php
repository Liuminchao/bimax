                ...
                <div class="row">
                    <div class="col-12" style="text-align: center">
                        ...
                        <div class="row" style="margin-top: 8px;">
                            <div class="col-sm-1 control-label padding-lr5" style="padding-left: 15px;">
...
//                            }
                                        echo "<button type='button' class='btn btn-primary' style='background-color: #FF9966;margin-left: 5px;' onclick='close_check(\"$check_id\")'>Mark as Closed</button>";
                                    }
//                        else{
//                            if($user[0]['user_id'] == $reply[0]['user_id']){
//                                echo "<button type='button' class='btn btn-primary' style='background-color:#20B2AA;margin-right: 40px;' onclick='reply(\"$check_id\")'>Reply</button>";
...
//                        }
                        ...
                        foreach($detail_list as $m => $n){
                            ...
                            <div class='row' style='margin-top: 8px;'>
                                ...
                                echo "</div><div class='col-sm-5 padding-lr5' style='text-align: left;'><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span></div></div>";
...
//                }
                            ...
                            <div class='col-sm-3 padding-lr5' style='text-align: left;'>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='text-align: left'>Deadline</label>
                            ...
                            <div class='col-sm-3 padding-lr5' style='text-align: left;'>";
                                if($item_data['rvo'] == '1'){
                                    echo "<input type='radio' id='yes_rvo' name='rf[rvo]'  value='1' style='padding-left: 4px;' checked disabled > Yes
                                  <input type='radio' id='no_rvo' name='rf[rvo]'  value='2' style='padding-left: 4px;' disabled > No";
                                }else if($item_data['rvo'] == '2'){
                                    echo "<input type='radio' id='yes_rvo' name='rf[rvo]'  value='1' style='padding-left: 4px;' disabled > Yes
                                  <input type='radio' id='no_rvo' name='rf[rvo]'  value='2' style='padding-left: 4px;' checked disabled > No";
                                }
                                echo "</div></div>";

                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left'>Discipline</label>
                            <div class='col-sm-4 padding-lr5' style='text-align: left;'>";
                                ...
                                echo "</div></div>";
                                $related_to = $item_list[0]['related_to'];
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left'>Particulars of Information (Related to)</label>
                            <div class='col-sm-4 padding-lr5' style='text-align: left;'>
                                $related_to
                            </div>
                          </div>";
                                $location_ref = $item_list[0]['location_ref'];
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left'>Location, Drawing Ref No:</label>
                            <div class='col-sm-4 padding-lr5' style='text-align: left;'>
                                $location_ref
                            </div>
                          </div>";
                            ...
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left'>Attachment(".$count.")</label>";
                                ...
                                foreach($attach_list as $i => $j){
                                    ...
                                    if($doc_arr[1] == 'dwg' || $doc_arr[1] == 'zip' || $doc_arr[1] == 'rar'){
                                        echo "<div class='row col-12 ' style='margin-top: 8px;'><div class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left;'><img src='img/attach.png'>$doc_name</div><div class='col-sm-2 padding-lr5' style='text-align: left'><a  class='a_logo' onclick='download_one(\"$doc_path\",\"$doc_name\")' title='Download'><i class='fa fa-fw fa-download'></i></a><a onclick='save_one(\"$check_id\",\"$doc_path\")'><i class='fa fa-fw fa-save' title='Save as'></i></a></div></div>";
                                    }else{
                                        echo "<div class='row col-12 ' style='margin-top: 8px;'><div class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left;'><img src='img/attach.png'>$doc_name</div><div class='col-sm-2 padding-lr5' style='text-align: left'><a  class='a_logo' onclick='previewdoc(\"$file_path\")' style='cursor:pointer' title='Preview'><i class='fa fa-fw fa-eye'></i></a><a  class='a_logo' onclick='download_one(\"$doc_path\",\"$doc_name\")' style='cursor:pointer;margin-left: 5px;' title='Download'><i class='fa fa-fw fa-download'></i></a><a class='a_logo' onclick='save_one(\"$check_id\",\"$doc_path\")' style='cursor:pointer;margin-left: 5px;' title='Save as'><i class='fa fa-fw fa-save'></i></a></div></div>";
                                    }
                                }
                                echo "</div>";
                          ...
                          <div class='row' style='margin-top: 8px;'>
                            ...
                            <div class='col-sm-3 padding-lr5' style=''>";
                                $to_user = '';
                                foreach($rf_user_list as $i => $j){
                                    if($j['type'] == '1'){
                                        $user_model = Staff::model()->findByPk($j['user_id']);
                                ...
                                echo $to_user;
                                echo "</div>
                                <div class='col-sm-5 padding-lr5' style=''><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span>
                            </div>
                        </div>";
                            ...
                            <label for='program_name' class='col-sm-2 offset-md-3 control-label padding-lr5' style='text-align: left'>Attachment(".$count.")</label>";
                                ...
                                foreach($attach_list as $i => $j){
                                    ...
                                    $doc_arr = explode('.',$j['doc_name']);
                                    if($doc_arr[1] == 'dwg' || $doc_arr[1] == 'zip' || $doc_arr[1] == 'rar'){
                                        echo "<div class='row col-12 offset-md-1' style='margin-top: 8px;'><div class='col-sm-1 offset-md-1 padding-lr5'></div><div class='col-sm-6 padding-lr5' style='text-align: left;padding-left: 0px;'><img src='img/attach.png'>$doc_name</div><div class='col-sm-2 padding-lr5' style='text-align: left'><a  class='a_logo' onclick='download_one(\"$doc_path\",\"$doc_name\")' title='Download'><i class='fa fa-fw fa-download'></i></a><a onclick='save_one(\"$check_id\",\"$doc_path\")'><i class='fa fa-fw fa-save' title='Save as'></i></a></div></div>";
                                    }else{
                        ...
                        <div class='row' style='margin-top: 8px;'>
                            ...
                            <label for='program_name' class='col-sm-2 control-label padding-lr5' style='text-align: left'>Attachment(".$count.")</label>";
                                ...
                                echo "
                                <div class='col-sm-3 padding-lr5'><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span>
                            </div>
                        </div>";
