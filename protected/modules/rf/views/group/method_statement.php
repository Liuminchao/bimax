            ...
            <div class="card-body">
                <form id="form1" >
                    <div class="form-group" style="margin-top: 10px;" >
                        <label for="template_name" class="col-2 control-label label-rignt padding-lr5">Group Name</label>
                    ...
                    <div class="form-group" style="margin-top: 10px;">
                        <label for="template_name" class="col-2 control-label label-rignt padding-lr5">User</label>
                        <div  class="col-6 padding-lr5">
                            ...
                            if($group_id != '' && count($detail_list)>0) {
                                foreach ($detail_list as $i => $j) {
                                    ...
                                    <tr id="row<?php echo $i; ?>">
                                        <td align="center">
                                            <select name="group[contractor_id]" id="contractor_id<?php echo $i; ?>" class="form-control input-sm none_input" onchange="user_data(0)">
                                                <?php
                                        ...
                                        <td align="center">
                                            <select name="group[user_id]" id="user_id<?php echo $i; ?>" class="form-control input-sm none_input">
                                                <?php
...
//        var clt_type = myType.options[index].value;//获取选项中options的value值
    ...
    var back = function (program_id) {
        window.location = "./?<?php echo Yii::app()->session['list_url']['rf/group/list']; ?>";
    }
