...
async function onLoad() {
    ...
    $.ajax({
        data: {id: id},
        url: "index.php?r=rf/rf/getattachmentcomponent",
        dataType: "json",
        type: "POST",
        success: function (data) {
            if(data.model_id){
...
async function getEntityParameter() {
    ...
    $.ajax({
        data: {model_id: model_id,id: id,uuid: uuid,entityId :entityId,version :version},
        url: "index.php?r=rf/rf/addattachmentcomponent",
        dataType: "json",
        type: "POST",
        success: function (data) {
