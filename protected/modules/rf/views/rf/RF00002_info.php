...
//                        }
                                    if($type == '1'){
                                        echo "<button type='button' class='btn btn-primary' style='background-color:#20B2AA;margin-left: 5px;' onclick='reply(\"$check_id\")'>Reply</button>";
                                    }else if($type != '0'){
                                        echo "<button type='button' class='btn btn-primary' style='background-color:#20B2AA;margin-left: 5px;' onclick='comment(\"$check_id\")'>Comment</button>";
                                    }
                                }else if($status == '1'){
                                    if($user[0]['user_id'] == $apply_user_id){
                                        echo "<button type='button' class='btn btn-primary' style='background-color:#20B2AA;margin-left: 5px;' onclick='forward(\"$check_id\")'>Forward</button>";
                                    }
                                }
                                ?>
                            </div>
                        ...
                        <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>From</label>
                        <div class='col-sm-3 padding-lr5' style='padding-top:7px;text-align: left;'>";
                                $rf_model = RfList::model()->findByPk($check_id);
                                $apply_user_id = $rf_model->apply_user_id;
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                        <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>To $group_name</label>
                        <div class='col-sm-3 padding-lr5' style='padding-top:7px;text-align: left;'>";
                                $to_user = '';
...
//                        }
                            ...
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Cc</label>
                            <div class='col-sm-8 padding-lr5' style='padding-top:7px;text-align: left;'>";
                                $cc_user = '';
                                foreach($rf_user_list as $i => $j){
                                    if($j['type'] == '2'){
                                        $user_model = Staff::model()->findByPk($j['user_id']);
                                ...
                                $cc_user = substr($cc_user, 0, strlen($to_user) - 1);
                                echo $cc_user;
                                echo "</div></div>";

                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Submission</label>
                            <div class='col-sm-3 padding-lr5' style='padding-top:7px;text-align: left;'>";
                                if($submission == '1'){
                                    echo '1st Submission';
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Subject*</label>
                            <div class='col-sm-6 padding-lr5' style='padding-top:7px;text-align: left;'>";
                                echo $item_list[0]['subject'];
                                echo "</div></div>";

                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Rvo</label>";
                                if($item_data['rvo'] == '1'){
                                    echo "
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                        <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Discipline</label>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                        <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Type of service</label>
                        <div class='col-sm-3 padding-lr5' style='padding-top:7px;text-align: left;'>";
                                echo $item_data['service'];
                                echo "</div></div>";

                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Latest Date to Reply</label>
                            <div class='input-group col-sm-3 padding-lr5' style='padding-top: 7px;text-align: left;'>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Trade</label>
                            <div class='input-group col-sm-3 padding-lr5' style='padding-top: 7px;text-align: left;'>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Masterial/Equipment Specified</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $mas_spc
                            </div>
                          </div>";
                                $loc_ins = $item_data['loc_ins'];
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Location To Be Installed</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $loc_ins
                            </div>
                           </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Masterial/Equipment Submitted</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $mas_sub
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Supplier</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $supplier
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>HDB List of Approved Supplier</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $hdb_sup
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Manufacturer/Brand</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $brand
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Model / Type</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $model
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Country of Origin</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $origin
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Complaince With Specifications/standard</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $comp_spec
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Technical Brochures Submitted</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $tech_sub
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Test Certificate Submitted</label>
                            <div class='col-sm-4 padding-lr5' style='padding-top:7px;text-align: left;'>
                                $cert_sub
                            </div>
                          </div>";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                        <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Attachment(".$count.")</label>";
                                if(count($attach_list)>0){
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-4 offset-md-1 control-label padding-lr5' style='padding-top:7px;text-align: left'>Message</label>
                          </div>
                          ...
                          <div class='row' style='margin-top: 8px;'>
                            ...
                            <div class='row' style='margin-top: 8px;'>
                                ...
                                <label for='program_name' class='col-sm-2  control-label padding-lr5' style='padding-top:7px;text-align: left'>To*</label>
                                <div class='col-sm-3 padding-lr5' style='padding-top:7px;text-align: left'>";
                                $to_user = '';
                                foreach($rf_user_list as $i => $j){
                                    if($j['type'] == '1'){
                                ...
                                echo $to_user;
                                echo "</div>
                          <div class='col-sm-4 padding-lr5' style='padding-top:7px;'><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span></div>
                        </div>";

                                echo "<div class='row' style='margin-top: 8px;' >
                            <label for='program_name' class='col-sm-2 offset-md-3 control-label padding-lr5' style='padding-top:7px;text-align: left'>Cc</label>
                            <div class='col-sm-7 padding-lr5' style='padding-top:7px;text-align: left'>";
                                $cc_user = '';
                                foreach($rf_user_list as $i => $j){
                                    if($j['type'] == '2'){
                                        $user_model = Staff::model()->findByPk($j['user_id']);
                                ...
                                if($params != '') {
                                    ...
                                    if(array_key_exists('rvo',$params_arr)){
                                        echo "<div class='row' style='margin-top: 8px;'>
                                    <label for='program_name' class='col-sm-2 offset-md-3 control-label padding-lr5' style='padding-top:7px;text-align: left'>RVO</label>
                                    <div class='col-sm-3 padding-lr5' style='padding-top:7px;text-align: left'>";
                                        if($params_arr['rvo'] == '1'){
                          ...
                          <input type='radio'  style='padding-left: 4px;' checked disabled > NA";
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name'class='col-sm-2 offset-md-3 control-label padding-lr5' style='padding-top:7px;text-align: left'>Attachment(".$count.")</label>";
                                if(count($attach_list)>0){
                                    echo "<div class='col-sm-2 padding-lr5' style='text-align: left;'><a onclick='zip(\"$check_id\",\"$step\")'>
                                            <h3 style='cursor:pointer;color: #4a86e8'>Download Zip</h3>
                                        </a></div>
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                            <label for='program_name' class='col-sm-4 offset-md-3 control-label padding-lr5' style='padding-top:7px;text-align: left'>Message</label>
                          </div>
                          ...
                          <div class='row' style='margin-top: 8px;'>
                            ...
                            <label for='program_name' class='col-sm-2 control-label padding-lr5' style='text-align: left'>Attachment(".$count.")</label>";
                                ...
                                echo "
                                <div class='col-sm-3 padding-lr5' style='padding-top:7px;'><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span></div>
                        </div>";
