...
<ul id="myTab" class="nav nav-tabs">
    ...
    <li class="active"><a href="index.php?r=proj/staff/pertabs&user_id=<?php echo $user_id; ?>&program_id=<?php echo $program_id ?>&mode=<?php echo $_mode_; ?>&title=<?php echo $title; ?>"><?php echo Yii::t('comp_staff','Personal Info');?></a></li>
...
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade in active" id="personal">
        ...
        //var_dump($msg);
        if($_mode_ == "insert"){
            $this->renderPartial('_perform', array('model' => $model, 'infomodel' => $infomodel, '_mode_' => 'insert','user_id' => $user_id,'program_id'=>$program_id,'msg' => $msg));
        }else{
            $this->renderPartial('_perform', array('model' => $model, 'infomodel' => $infomodel, '_mode_' => 'edit','user_id' => $user_id,'program_id'=>$program_id,'msg' => $msg));
        }?>
    </div>
