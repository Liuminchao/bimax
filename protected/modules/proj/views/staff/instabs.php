...
<ul id="myTab" class="nav nav-tabs">
    <li ><a href="index.php?r=proj/staff/tabs&user_id=<?php echo $user_id; ?>&program_id=<?php echo $program_id ?>&mode=<?php echo $_mode_; ?>&title=<?php echo $title; ?>" ><?php echo Yii::t('comp_staff','Base Info');?></a></li>
...
<!--    <li ><a href="index.php?r=comp/staff/csoctabs&user_id=--><?php //echo $user_id; ?><!--&mode=--><?php //echo $_mode_; ?><!--&title=--><?php //echo $title; ?><!--" >--><?php //echo Yii::t('comp_staff','csoc');?><!--</a></li>-->
    <li class="active"><a href="index.php?r=proj/staff/instabs&user_id=<?php echo $user_id; ?>&program_id=<?php echo $program_id ?>&mode=<?php echo $_mode_; ?>&title=<?php echo $title; ?>" ><?php echo Yii::t('comp_staff','ins');?></a></li>
...
<div id="myTabContent" class="tab-content">
    <div class="tab-pane fade in active" id="ins">
        <br/>
        <?php
        //var_dump($msg);
        if($_mode_ == "insert"){
            $this->renderPartial('_insform', array('model' => $model, 'infomodel' => $infomodel, '_mode_' => 'insert','user_id' => $user_id,'program_id'=>$program_id,'msg' => $msg));
        }else{
            $this->renderPartial('_insform', array('model' => $model, 'infomodel' => $infomodel, '_mode_' => 'edit','user_id' => $user_id,'program_id'=>$program_id,'msg' => $msg));
        }?>
    </div>
