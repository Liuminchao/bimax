...
//                        }
                            ...
                            <div class='input-group col-sm-3 padding-lr5' style=';text-align: left;'>";
                                ...
                                $trade_name = $trade_list[$item_list[0]['trade']];
                                echo $trade_name;
                                echo "</div></div>";
                            ...
                            <div class='col-sm-4 padding-lr5' style='text-align: left;'>
                                ...
                                $location_ref = $item_data['location'];
                                echo "<div class='row' style='margin-top: 8px;'>
                                ...
                                echo "<div class='row' style='margin-top: 8px;'>
                                <label for='program_name' class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left'>Specification Ref (Clause):</label>
                                <div class='col-sm-6 padding-lr5' style='text-align: left;'>";
                                if($item_data['spec_ref'] == 'Complied'){
                                    echo "<input type='radio' id='complied' name='rf[spec_ref]'  value='Complied' checked  disabled > Complied
                                ...
                                }else if($item_data['spec_ref'] == 'Partially Complied'){
                                    echo "<input type='radio' id='complied' name='rf[spec_ref]'  value='Complied'  disabled > Complied
                                              ...
                                              <input type='radio' id='not_complied' name='rf[spec_ref]'  value='Not Complied' style='padding-left: 4px;' disabled > Not Complied";
                                }else if($item_data['spec_ref'] == 'Not Complied'){
                                    echo "<input type='radio' id='complied' name='rf[spec_ref]'  value='Complied'  disabled > Complied
                                              <input type='radio' id='partially_complied' name='rf[spec_ref]'  value='Partially Complied' style='padding-left: 4px;' disabled > Partially Complied
                          ...
                          <div class='row' style='margin-top: 8px;'>
                            ...
                            <div class='row' style='margin-top: 8px;'>
                                ...
                                echo $to_user;
                                echo "</div>
                                <div class='col-sm-4 padding-lr5' style=''><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span>
                            </div>
                        </div>";
                        ...
                        <div class='row' style='margin-top: 8px;'>
                            <div class='col-sm-8 offset-md-3 padding-lr5'>
                                ...
                                echo "<div class='col-sm-3 padding-lr5' style=''><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span></div>
                        </div>";
