<div class="row" >
    ...
    <div class="col-3">
        ...
        <button class="btn btn-primary btn-sm" onclick="itemAdd('<?php echo $program_id; ?>')">Upload</button>
        </label>
         * <label  class="padding-lr5 float-sm-right">
        <button class="btn btn-primary btn-sm" onclick="itemBatchDelete('<?php echo $program_id; ?>')">Batch Delete</button>
        </label>
         */
        ?>
        <label  class="padding-lr5 float-sm-right">
        ...
        <label  class="padding-lr5 float-sm-right">
            <button class="btn btn-primary btn-sm" onclick="itemEditPbutype('<?php echo $program_id; ?>','<?php echo $pbu_tag; ?>')">Edit</button>
        </label>
        <label  class="padding-lr5 float-sm-right">
            <button class="btn btn-success btn-sm" onclick="itemExportQr('<?php echo $program_id; ?>','<?php echo $pbu_tag; ?>')">QR Code</button>
        </label>
        </div>
</div>
