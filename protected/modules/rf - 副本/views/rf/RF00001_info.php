...
<div class="container" style="padding-top: 8px;">
    <div class="row">
        ...
        <div class="col-8" style="background-color: #F2F2F2;text-align: center">
...
//                        }
            ...
            foreach($detail_list as $m => $n){
                ...
                if($n['status'] == '1' || $n['status'] == '4'){
                    ...
                    echo "</div><div class='col-sm-6 padding-lr5' style='padding-top:7px;text-align: left;'><span class='label label-default' style='float: right;color:#333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span></div></div>";
...
//                        }
                    ...
                    echo $to_user;
                    echo "</div>
                                <div class='col-sm-6 padding-lr5' style='padding-top:7px;'><span class='label label-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span>
                            </div>
                        </div>";
                    ...
                    echo "</div>
                                <div class='col-sm-6 padding-lr5'><span class='label label-default' style='float: right;margin-right: 42px;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;margin-right: 42px;'>$apply_time</span>
                            </div>
                        </div>";
