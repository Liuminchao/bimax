    ...
    <div class="col-12">
        <div class="card card-info card-outline">
            <div class="card-body" style="background-color: #F2F9FA;">
                ...
                <div class="form-group" style="margin-top: 10px;border-bottom:4px solid #F2F2F2;padding-bottom:8px;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-4 padding-lr5" style="margin-left:15px;padding-left: 0px;margin-bottom:0px;">
