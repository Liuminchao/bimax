...
//        }
        ...
        echo $to_user;
        echo "</div><div class='col-sm-5 padding-lr5' style=''>
        ...
        echo "</div>
                                <span class='badge bg-default' style='float: right;margin-right: 42px;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;margin-right: 42px;'>$apply_time</span>
                            </div>
                        </div>";
