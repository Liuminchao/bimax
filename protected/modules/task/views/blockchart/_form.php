...
<div class="container">
    ...
    <div class="form-group" style="margin-top: 10px;">
        <label for="role_name" class="col-sm-4 control-label padding-lr5">Block</label>
    ...
    <div class="form-group" style="margin-top: 10px;">
        <label for="role_name_en" class="col-sm-4 control-label padding-lr5">S_Val</label>
        <div class="col-sm-6 padding-lr5">
    ...
    <div class="form-group" style="margin-top: 10px;">
        <label for="team_name" class="col-sm-4 control-label padding-lr5">T_Val</label>
        <div class="col-sm-6 padding-lr5">
