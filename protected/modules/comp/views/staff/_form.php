...
<!--        <div class="col-md-6">  白名单 
    ...
    <div class="row">
        ...
        <div class="form-group" >
                 <label for="face_img" style="margin-left: 15px" class="col-sm-3 control-label padding-lr5" ><?php echo $model->getAttributeLabel('face_img');?></label>
        ...
        <div class="col-md-6"><!--  入职时间 -->
            <div class="form-group">
                <label style="margin-left:15px" for="bca_service_date" class="col-sm-3 control-label padding-lr5"><?php echo $infomodel->getAttributeLabel('Joined Date'); ?></label>
