            ...
            <div class="card-body" style="background-color: #F2F9FA;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="service" class="form-control" name="item[service]" check-type="required" required-message="Project Name can not be empty"  type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-3 padding-lr5" style="padding-left: 0px;margin-bottom:0px;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="mas_spc" class="form-control" name="item[mas_spc]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="loc_ins" class="form-control" name="item[loc_ins]" check-type="required" required-message="Project Name can not be empty"  type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="mas_sub" class="form-control" name="item[mas_sub]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="supplier" class="form-control" name="item[supplier]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="hdb_sup" class="form-control" name="item[hdb_sup]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="brand" class="form-control" name="item[brand]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="hdb_mat" class="form-control" name="item[hdb_mat]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="model" class="form-control" name="item[model]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="origin" class="form-control" name="item[origin]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="comp_spec" class="form-control" name="item[comp_spec]"  type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="tech_sub" class="form-control" name="item[tech_sub]"   type="text" value="" >
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-7 padding-lr5" style="text-align: left;">
                        <input id="cert_sub" class="form-control" name="item[cert_sub]"   type="text" value="" >
                    </div>
                </div>
