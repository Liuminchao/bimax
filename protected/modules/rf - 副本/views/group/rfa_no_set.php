...
<div class="row">
    <div class="col-md-12">
        <label style='text-align: left' class='col-sm-3 control-label'><h3 class="text-blue">RFA Reference Number Settings</h3></label>
    </div>
</div>
...
<div calss="row">
    <div class="col-md-12">
        <div id="rfa_region_A">
            <?php
            echo "<label style='text-align: left' for='A' class='col-sm-3 control-label'>Company Name Short Form </label>";
...
<div calss="row">
    <div class="col-md-12">
        <div id="rfa_region_B">
            <?php
            echo "<br/>";
            echo "<label style='text-align: left' for='B' class='col-sm-3 control-label'>Project Site Short Form </label>";
...
<div calss="row">
    <div class="col-sm-12">
        <div id="rfa_region_C">
            <?php
            echo "<br/>";
            echo "<label style='text-align: left' for='C' class='col-sm-3 control-label'>Discipline Short Form </label>";
...
<div calss="row">
    <div class="col-sm-12">
        <div id="rfa_region_D">
            <?php
            echo "<br/>";
            echo "<label style='text-align: left' for='D' class='col-sm-3 control-label'>Type Name Short Form </label>";
...
<div class="row">
    <div class="col-md-12">
        <label style='text-align: left' class='col-sm-3 control-label'><h3 class="text-blue">RFI Reference Number Settings</h3></label>
    </div>
</div>
...
if($contractor_id == $user_contractor_id){
    ...
    <div class="row" style="margin-top: 30px;">
        <button type="button" class="btn btn-default btn-lg" style="display:block;margin:0 auto"  onclick="save_test();"><?php echo Yii::t('common', 'button_save'); ?></button>
    </div>
    <?php
}
?>
