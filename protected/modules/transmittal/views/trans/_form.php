...
<div class="box-body" style="padding-top: 8px;">
    ...
    <div class="col-xs-8" style="background-color: #F2F9FA;text-align: center">
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group" >
                <div class="col-sm-1 col-md-offset-2 padding-lr5" style="padding-top:7px;">
                    <button type="button" class="btn btn-primary" style="background-color: #778899;" onclick="cancel()">Cancel</button>
                </div>
            </div>
        </div>
        <div class="row" >
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group" >
                <label for="program_name" class="col-sm-1 col-md-offset-2 control-label padding-lr5" style="text-align: left">Type<span style="color: #c12e2a">*</span></label>
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group" style="border-bottom:4px solid #F2F2F2;padding-bottom:8px;">
                <label for="program_name" class="col-sm-1 col-md-offset-2 control-label padding-lr5" style="text-align: left">Ref no.<span style="color: #c12e2a">*</span></label>
                <div class="col-sm-5 padding-lr5" style="padding-bottom: 0;">
                    ...
                    <input type="text" class="form-control" id="no" name="rf[no]" placeholder="001" style="float: left;width:50px;margin-left: 2px;">
                </div>
            </div>
        </div>
...
<!--        <div class="row" style="margin-top: 8px;">-->
<!--            <div class="form-group" style="border-bottom:4px solid #F2F2F2;padding-bottom:8px;">-->
<!--                <label for="program_name" class="col-sm-1 col-md-offset-1 control-label padding-lr5" style="text-align: left">Ref No.</label>-->
<!--                <div class="col-sm-3 padding-lr5">-->
<!--                    <input id="check_no" name="rf[check_no]" class="form-control" style="background: #F2F2F2" type="text">-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <label for="program_name" class="col-sm-1 col-md-offset-2 control-label padding-lr5" style="text-align: left">To<span style="color: #c12e2a">*</span></label>
                <div class="col-sm-3 padding-lr5">
...
<!--                <button type="button" class="btn btn-primary" style="background-color: #169BD5">Directory</button>-->
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group ">
                <label for="program_name" class="col-sm-1 col-md-offset-2 control-label padding-lr5" style="text-align: left"></label>
...
<!--                </label>-->
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <label for="program_name" class="col-sm-1 col-md-offset-2 control-label padding-lr5" style="text-align: left">Cc</label>
                <div class="col-sm-3 padding-lr5">
...
<!--                <button type="button" class="btn btn-primary" style="background-color: #169BD5">Directory</button>-->
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">Latest Date to Reply</label>
                <div class="input-group col-sm-3 padding-lr5" style="padding-left: 20px;">
                    <?php
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group" >
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">Trade</label>
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group" style="border-bottom:4px solid #F2F2F2;padding-bottom:8px;">
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">Subject<span style="color: #c12e2a">*</span></label>
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group" >
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">RVO<span style="color: #c12e2a">*</span></label>
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;text-align: left;">
                    <input type="radio" id="yes_rvo" name="rf[rvo]"  value="1"   /> Yes
                    <input type="radio" id="no_rvo" name="rf[rvo]"  value="2" style="padding-left: 4px;"  /> No
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">Discipline<span style="color: #c12e2a">*</span></label>
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">Particulars of Information (Related to)</label>
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                    <input id="related" class="form-control" name="item[related]" check-type="required" required-message="Project Name can not be empty"  type="text" value="" >
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">Location, Drawing Ref No:</label>
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                    <input id="location" class="form-control" name="item[location]" check-type="required" required-message="Project Name can not be empty"  type="text" value="" >
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group" style="border-bottom:4px solid #F2F2F2;padding-bottom:8px;">
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">Specification Ref (Clause):</label>
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <label for="program_name" class="col-sm-2 col-md-offset-2 control-label padding-lr5" style="text-align: left">Attachment</label>
        ...
        <div class="row" >
            <table id="attach" class="col-md-offset-2" style="width: 70%">
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <label for="program_name" class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">Message</label>
            </div>
        </div>

        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <div class="col-sm-8 col-md-offset-2 padding-lr5">
        ...
        <div class="row" style="margin-top: 8px;">
            <div class="form-group">
                <div class="col-sm-4 col-md-offset-2 control-label padding-lr5" style="text-align: left">
                ...
                <div class="col-sm-4 control-label padding-lr5" style="text-align: left">
                    <button id="save_btn" type="button" class="btn btn-primary" style="background-color: #DEB887;float: right" onclick="send()" >Send</button>
                </div>
            </div>
        </div>
