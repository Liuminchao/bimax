...
<div class="row" style="margin-left: -20px;">
    ...
    <div class="col-xs-3">
        <div class="dataTables_filter" >
            <label>
                <button class="btn btn-primary btn-sm" onclick="itemUpload('<?php echo $program_id ?>')"><?php echo Yii::t('comp_document', 'upload'); ?></button>
                <?php if (Yii::app()->user->getState('operator_role') == '01'){ ?>
                    <button class="btn btn-primary btn-sm" onclick="itemAdd('<?php echo $program_id; ?>')">Create RFA</button>
                <?php } ?>
            </label>
        </div>
    </div>
