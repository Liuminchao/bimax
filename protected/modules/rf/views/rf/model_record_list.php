            ...
            <div class="box-body table-responsive">
                <div role="grid" class="dataTables_wrapper form-inline" id="<?php echo $this->gridId; ?>_wrapper">
                        ...
                        <div class="col-xs-11">
                            <div class="dataTables_length">
                                ...
                                <form name="_query_form" id="_query_form" role="form">
                                    <input type="hidden" name= "q[entityId]" id="entityId" value="">
                    ...
                    <div id="WindJS" style="position: relative;background: white;margin-top: 5px;">
                        <canvas id="View" class="js-rotate-05" style="top:0;left:0;height:400px;width:100%;"></canvas>
                    </div>
                    <div id="datagrid">
                        <?php $this->actionModelRecordGrid($program_id); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="js/select_model.js"></script>
