...
//                        }
            ...
            foreach($detail_list as $m => $n){
                ...
                if($n['status'] == '1' || $n['status'] == '4'){
                    ...
                    echo "</div><div class='col-sm-6 padding-lr5' style='padding-top:7px;text-align: left;'><span class='label label-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;margin-right: 42px;'>$apply_time</span></div></div>";
...
//                }
                    ...
                    foreach($attach_list as $i => $j){
                        ...
                        $doc_arr = explode('.',$j['doc_name']);
                        if($doc_arr[1] == 'dwg' || $doc_arr[1] == 'zip' || $doc_arr[1] == 'rar'){
                            echo "<tr> <td align='right'><img src='img/attach.png'></td><td align='left'>$doc_name</td> <td align='center' width='15%'><a onclick='download_one(\"$doc_path\",\"$doc_name\")'>Download</a></td><td align='center' width='15%'><a onclick='save_one(\"$check_id\",\"$doc_path\")'>Save as</a></td></tr>";
                        }else{
                            echo "<tr> <td align='right'><img src='img/attach.png'></td><td align='left'>$doc_name</td> <td align='center' width='15%'><a onclick='previewdoc(\"$file_path\")'>Preview</a></td><td align='center' width='15%'><a onclick='download_one(\"$doc_path\",\"$doc_name\")'>Download</a></td><td align='center' width='15%'><a onclick='save_one(\"$check_id\",\"$doc_path\")'>Save as</a></td></tr>";
                        }
                    }
                    echo " </table></div>";
                    ...
                    echo "</div>
                                <div class='col-sm-3 padding-lr5'><span class='label label-default' style='float: right;margin-right: 42px;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;margin-right: 42px;'>$apply_time</span>
                            </div>
                        </div>";
