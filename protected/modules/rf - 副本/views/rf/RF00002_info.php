...
//                        }
        ...
        if(count($attach_list)>0){
            echo "<button type='button' class='btn btn-primary' onclick='zip(\"$check_id\",\"$step\")'>
                    ...
                    echo "<div class='row' style='margin-top: 8px;' >
                            <label for='program_name' class='col-sm-1 offset-md-3 control-label padding-lr5' style='padding-top:7px;text-align: left'>Cc</label>
                            <div class='col-sm-3 padding-lr5' style='padding-top:7px;'>";
                    $cc_user = '';
                    foreach($rf_user_list as $i => $j){
                        if($j['type'] == '2'){
                    ...
                    if($params != '') {
                        ...
                        if(array_key_exists('rvo',$params_arr)){
                            echo "<div class='row' style='margin-top: 8px;'>
                                    <label for='program_name' class='col-sm-1 offset-md-3 control-label padding-lr5' style='padding-top:7px;text-align: left'>RVO</label>
                                    <div class='col-sm-3 padding-lr5' style='padding-top:7px;'>";
                            if($params_arr['rvo'] == '1'){
