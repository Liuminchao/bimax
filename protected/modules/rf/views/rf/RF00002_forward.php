            ...
            <div class="card-body" style="background-color: #F2F9FA;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-5 padding-lr5" style="padding-bottom: 0;margin-left:15px;">
                        ...
                        <select id="no_discipline" class="form-control" name="rf[no_discipline]" style="float: left;width:100px;margin-left: 2px;" check-type="required" >
                        ...
                        if(count($self_no_list) >0){
                            echo "<input type='text' class='form-control' id='no' name='rf[no]' placeholder='001' style='float: left;width:100px;margin-left: 2px;' value='{$self_no_list[4]}'>";
                        }else{
                            echo "<input type='text' class='form-control' id='no' name='rf[no]' placeholder='001' style='float: left;width:100px;margin-left: 2px;' >";
                        }
                        ?>
                    </div>
                </div>
