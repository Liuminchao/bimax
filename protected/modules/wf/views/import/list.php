...
<?php echo $this->gridId; ?>.refresh();
    ...
    var itemAdd = function (program_id) {
        window.location = "index.php?r=wf/import/view&program_id="+program_id;
    }
    //详情
    var itemDetail = function (form_id,program_id) {
        window.location = "index.php?r=wf/import/detaillist&form_id="+form_id+"&program_id="+program_id;
    }
    //修改
    ...
    var itemStart = function (id, name) {
        ...
        $.ajax({
            ...
            url: "index.php?r=wf/import/start",
            dataType: "json",
            type: "POST",
    ...
    var itemStop = function (id, name) {
        ...
        $.ajax({
            data: {id: id, confirm: 1},
            url: "index.php?r=wf/import/stop",
            dataType: "json",
            type: "POST",
            success: function (data) {
