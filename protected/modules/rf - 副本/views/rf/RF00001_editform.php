...
<div class="container" style="padding-top: 8px;">
    <div class="row">
        ...
        <div class="col-8" style="background-color: #F2F9FA;text-align: center">
            ...
            <div class="row" style="margin-top: 8px;">
                <label for="program_name" class="col-sm-4 offset-md-2 control-label padding-lr5" style="text-align: left">Rvo</label>
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                    <?php
                    if($item_data['rvo'] == '1'){
                        echo "
                ...
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                    <select id="discipline" class="form-control" check-type="required" name="rf[discipline]">
                        ...
                        if($item_list[0]['discipline'] == '1'){
                            echo "<option value='1' selected='selected'>Structural</option>
                                      <option value='2' >Architecture</option>
                                      <option value='3' >M&E</option>";
                        }else if($item_list[0]['discipline'] == '2'){
                            echo "<option value='1' >Structural</option>
                                      <option value='2' selected='selected'>Architecture</option>
                                      <option value='3' >M&E</option>";
                        }else if($item_list[0]['discipline'] == '3'){
                            echo "<option value='1' >Structural</option>
                                      <option value='2' >Architecture</option>
                                      <option value='3' selected='selected'>M&E</option>";
                        }
                        ?>
            ...
            <div class="row" style="margin-top: 8px;">
                ...
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                    <input id="related" class="form-control" name="item[related]" check-type="required" required-message="Project Name can not be empty"  type="text" value="<?php echo $item_data['related'] ?>" >
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 8px;">
                ...
                <div class="col-sm-4 padding-lr5" style="margin-left: 15px;">
                    <input id="location" class="form-control" name="item[location]" check-type="required" required-message="Project Name can not be empty"  type="text" value="<?php echo $item_data['location'] ?>" >
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 8px;">
                ...
                <div class="col-sm-5 padding-lr5" style="margin-left: 15px;text-align: left;">
                    ...
                    if($item_data['spec_ref'] == 'Complied'){
                        ...
                        echo "
                                <input type='radio' id='complied' name='item[spec_ref]'  value='Complied'  /> Complied
                                <input type='radio' id='partially_complied' name='item[spec_ref]'  value='Partially Complied' style='padding-left: 4px;' checked /> Partially Complied
                                <input type='radio' id='not_complied' name='item[spec_ref]'  value='Not Complied' style='padding-left: 4px;'  /> Not Complied
                            ";
                        ...
                        echo "
                                <input type='radio' id='complied' name='item[spec_ref]'  value='Complied'  /> Complied
                                <input type='radio' id='partially_complied' name='item[spec_ref]'  value='Partially Complied' style='padding-left: 4px;'  /> Partially Complied
                                <input type='radio' id='not_complied' name='item[spec_ref]'  value='Not Complied' style='padding-left: 4px;' checked /> Not Complied
                            ";
                    }
                    ?>
                </div>
            ...
            <div class="row" >
                <table id="attach" class="offset-md-2" style="width: 70%">
                    <?php
