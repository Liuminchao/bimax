...
//                }
                            ...
                            <label for='program_name' class='col-sm-2 offset-md-1 control-label padding-lr5' style='text-align: left'>Rvo</label>";
                                if($item_data['rvo'] == '1'){
                                    echo "<div class='col-sm-3 padding-lr5' style='text-align: left;'>
                          ...
                          <div class='col-sm-3 padding-lr5' style='text-align: left;'>         
                            ...
                            <div class='col-sm-3 padding-lr5' style=';text-align: left;'>$prepared_by</div>
                            <label for='program_name' class='col-sm-2 control-label padding-lr5' style='text-align: left'>Subcon</label>
                            <div class='col-sm-3 padding-lr5' style=';text-align: left;'>$subcon</div>
                      </div>";
                            ...
                            <div class=' col-sm-3 padding-lr5' style=';text-align: left;'>";
                                ...
                                foreach($attach_list as $i => $j){
                                    ...
                                    if($doc_arr[1] == 'dwg' || $doc_arr[1] == 'zip' || $doc_arr[1] == 'rar'){
                                        echo "<div class='row col-12 ' style='margin-top: 8px;'><div class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left;padding-left: 0px;'><img src='img/attach.png'>$doc_name</div><div class='col-sm-2 padding-lr5' style='text-align: left'><a  class='a_logo' onclick='download_one(\"$doc_path\",\"$doc_name\")' title='Download'><i class='fa fa-fw fa-download'></i></a><a onclick='save_one(\"$check_id\",\"$doc_path\")'><i class='fa fa-fw fa-save' title='Save as'></i></a></div></div>";
                                    }else{
                                        echo "<div class='row col-12 ' style='margin-top: 8px;'><div class='col-sm-5 offset-md-1 control-label padding-lr5' style='text-align: left;padding-left: 0px;'><img src='img/attach.png'>$doc_name</div><div class='col-sm-2 padding-lr5' style='text-align: left'><a  class='a_logo' onclick='previewdoc(\"$file_path\")' style='cursor:pointer' title='Preview'><i class='fa fa-fw fa-eye'></i></a><a  class='a_logo' onclick='download_one(\"$doc_path\",\"$doc_name\")' style='cursor:pointer;margin-left: 5px;' title='Download'><i class='fa fa-fw fa-download'></i></a><a class='a_logo' onclick='save_one(\"$check_id\",\"$doc_path\")' style='cursor:pointer;margin-left: 5px;' title='Save as'><i class='fa fa-fw fa-save'></i></a></div></div>";
                                    }
                                }
                                echo "</div>";
                            ...
                            <div class='row' style='margin-top: 8px;'>
                                ...
                                if($params != '') {
                                    ...
                                    if(array_key_exists('valid_time',$params_arr)){
                                        ...
                                        echo "<div class='row' style='margin-top: 8px;'>
                                <div class='row' style='margin-top: 8px;'>
                                <label for='program_name' class='col-sm-2 offset-md-3 control-label padding-lr5' style='text-align: left'>Latest Date to Reply</label>
                                    <div class='col-sm-5 padding-lr5' style=';text-align: left;'>";
                        ...
                        <div class='row' style='margin-top: 8px;'>
                            ...
                            ";
                                ...
                                echo "<div class='col-sm-3 padding-lr5'><span class='badge bg-default' style='float: right;color: #333;background-color: $color_list[$deal_type]'>$type_list[$deal_type]</span><br><span style='float: right;'>$apply_time</span>
                            </div>
                        </div>";
