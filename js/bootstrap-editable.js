...
(function ($) {
    ...
    */      
    ...
    '<div class="editable-input"></div><div class="editable-buttons" style="margin-left: 5px;"></div>'+
    '</div>' +
    '</form><div class="control-group"><div class="editable-error-block"></div></div>';
...
(function ($) {
    ...
    $.fn.editableform.buttons = 
      ...
      '</button>'+
      '<button type="button" class="btn btn-default btn-sm editable-cancel" style="margin-left: 5px;">'+
