            ...
            <div class="card-body" style="background-color: #F2F9FA;">
                ...
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-3 padding-lr5" style="padding-left: 0px;margin-bottom:0px;">
                        <div class="input-group date padding-lr5" data-target-input="nearest" style="padding-left: 5px;">
                            ...
                            ?>
                            <input type="text" class="form-control datetimepicker-input b_date_ins" data-target="#q_start_date" name="rf[valid_time]"
                ...
                <div class="form-group" style="height:200px;margin-top: 10px;">
                    ...
                    <div class="col-sm-8 padding-lr5">
                        <textarea  id="message" name = "rf[message]" style="height:200px;width:100%"></textarea>
                    </div>
                </div>
