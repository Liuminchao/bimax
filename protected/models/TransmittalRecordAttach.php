...
/**
 * TransmittalRecordAttach
 * @author LiuMinchao
 */
class TransmittalRecordAttach extends CActiveRecord {
...
//                    $upload_file = $upload.$name;
                ...
                $sql = "insert into transmittal_record_attach (check_id,step,doc_name,purpose,doc_path) values (:check_id,:step,:doc_name,:purpose,:doc_path)";
                ...
                $command->bindParam(":purpose", $args['purpose'][$i], PDO::PARAM_STR);
...
//                $trans->rollBack();
    ...
    public static function dealList($check_id) {
        $sql = "select * from transmittal_record_attach
