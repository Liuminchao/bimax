        ...
        <form enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-top:30px;">
                <div class="input-group " style="margin-left:25%">
                    <a href="javascript:void(0)" onclick="downloadFile('<?php echo $pbu_tag; ?>')" style="height: 34px;"><input type="button" class="btn btn-primary" value="<?php echo Yii::t('comp_staff','Template Download');?>" /></a>
                    <div class="col-4 control-label" style="text-align: left;margin-left:15px;"><?php echo Yii::t('comp_staff', 'Prompt_Template'); ?></div>
                </div>
            </div>
            <hr/>
            
            <div class="form-group group-space-between" style="margin-bottom:20px;">
                <label for="form_type" class="col-2 control-label offset-md-1 label-rignt padding-lr5"></label>
                <div class="input-group col-8">
                    <div class="col-9 padding-lr5">
                        <input type="radio" name="size_radio" id="blockchart_a" checked="checked" />Block Chart A
                        <input type="radio" name="size_radio" id="blockchart_b" >Block Chart B
                    </div>
                </div>
            </div>
...
//     })
    ...
    //模板下载
    var downloadFile = function (pbu_tag) {
        // var template_id = $('#template_id').val();
        var url = './index.php?r=task/model/download&pbu_tag='+pbu_tag;
...
//                type: 'post',
//                url: './index.php?r=task/model/getmodeldata',
//                dataType: 'json',
//                success: function (data, textStatus) {
//                    var url = './index.php?r=task/model/export&id_version='+id_version+'&program_id='+program_id;
//                    window.location.href=url;
//                },
//                error: function(XMLHttpRequest, textStatus, errorThrown){
...
//            });
//        }else{
//            var url = './index.php?r=task/model/download&id_version='+id_version;
//            window.location.href=url;
//        }
    }
    //上传是否为空
...
//                alert('进来了');
    ...
    var ajaxReadData = function (filename, rowcnt, startrow){//alert('aa');
        ...
        // var id_version = obj.options[index].value; // 选中值
        jQuery.ajax({
            data: {filename:filename, startrow: startrow, per_read_cnt:per_read_cnt, id:id, blockchart:blockchart,pbu_tag:pbu_tag},
            type: 'post',
            url: './index.php?r=task/model/readdata',
            dataType: 'json',
            success: function (data, textStatus) {
                for (var o in data) {
