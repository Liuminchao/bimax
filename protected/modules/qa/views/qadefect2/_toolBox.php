    ...
    <div class="col-12">
        <div class="dataTables_length">
            <form class="form-inline" name="_query_form" id="_query_form" role="form">
                ...
                <input type="hidden" name="q[phase]" value="<?php echo $phase; ?>">
                ...
                <div class="form-group padding-lr5" style="padding-bottom:5px;width: 200px">
                    <select class="form-control input-sm" name="q[type_id]" style="width: 100%;">
                        ...
                        <?php
                        $type_list = QaDefectProjectType::QueryType($program_id,$phase);
                        if(count($type_list)>0){
                            foreach ($type_list as $type_2 => $type3_list){
                                echo "<optgroup label='$form_type_name'>";
                                foreach ($type3_list as $type_3 => $type_id){
                                    echo "<option value='".$val."'";
                                    if ($args['type_id'] == $type_id) {
                                        echo " selected";
                                    }
                                    echo ">".$type_3."</option>";
                                }
