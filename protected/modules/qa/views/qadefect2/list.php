...
//        modal.title = "["+app_id+"] <?php //echo Yii::t('sys_workflow', 'Approval Process'); ?>//";
        ...
        modal.url = "index.php?r=qa/qadefect2/downloadattachment&check_id="+id;
        modal.modal();
    }
    //Workflow
    var itemWorkflow = function (check_id) {
        ...
        modal.url = "index.php?r=qa/qadefect2/workflow&check_id="+check_id;
        modal.modal();
    }
</script>
        ...
        <div class="card card-info card-outline">
            ...
            <div class="card-body" style="overflow-x: auto">
                <div role="grid" class="dataTables_wrapper " id="<?php echo $this->gridId; ?>_wrapper">
                    <?php $this->renderPartial('_toolBox',array('program_id'=>$program_id,'args'=>$args,'phase'=>$phase)); ?>
