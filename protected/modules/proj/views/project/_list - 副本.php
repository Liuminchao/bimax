            ...
            if($value == '0'){
                if($row['default_program_type'] == 1){
                    $link.="<div class='row'>
                                ...
                                <div class='col-3'>
                                    <label><button class='btn btn-danger btn-sm' onclick='itemDel(\"{$row['program_id']}\",\"{$row['program_name']}\")'>Delete</button></label>
                                </div>
                            </div>";
                }
            }else if($value == '1'){
                if($row['default_program_type'] == 1){
                    $link.="<div class='row'>
                                ...
                                <div class='col-3'>
                                    <label>
                                        <button class='btn btn-primary btn-sm' onclick='itemEdit(\"{$row['program_id']}\")'>Edit</button>
                                        <button class='btn btn-danger btn-sm' onclick='itemDel(\"{$row['program_id']}\",\"{$row['program_name']}\")'>Delete</button>
                                    </label>
                                </div>
                            </div>";
                }else{
                        ...
                        $link.="<div class='row'>
                                    ...
                                    <div class='col-3' style='text-align: right'>    
                                        <label>
                                            <button class='btn btn-primary btn-sm' onclick='itemEdit(\"{$row['program_id']}\")'>Edit</button>
                                            <button class='btn btn-danger btn-sm' onclick='itemDel(\"{$row['program_id']}\",\"{$row['program_name']}\")'>Delete</button>
                                            <button class='btn btn-warning btn-sm' onclick='itemStop(\"{$row['program_id']}\",\"{$row['program_name']}\")'>Stop</button>
                                        </label>
                                    </div>
                                </div>";
                    }
